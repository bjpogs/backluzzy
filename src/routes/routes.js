...
router.get('/getshopproducts', controller.getshopproducts);
...
// update product
router.post('/updateshopproduct',  controller.updateshopproduct);

// test body
router.post('/testfucker', controller.testfucker);
...
// get all my build rder
router.get('/mybuildorder',controller.myallcustomorder)

// get all my reservation order
router.get('/myreservationorder',controller.myallreservationorder)
